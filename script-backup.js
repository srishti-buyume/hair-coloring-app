...
const createImageSegmenter = async () => {
    ...
    imageSegmenter = await ImageSegmenter.createFromOptions(vision, {
        baseOptions: {
            modelAssetPath: "./hair_segmenter.tflite", // "./models/selfie_multiclass.tflite",
            //  "https://cdn.glitch.global/eb18e63f-936a-4172-8bdd-9263c7a6a04a/hair_segmenter.tflite?v=1689603953377",
            delegate: "GPU"
        },
...
// mycode
function callbackForVideo2(result) {
...
async function predictWebcam() {
    ...
    imageSegmenter.segmentForVideo(video, startTimeMs, callbackForVideo2);
}
